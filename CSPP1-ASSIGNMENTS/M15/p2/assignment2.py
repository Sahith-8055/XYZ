...
class Message:
    ...
    def build_shift_dict(self, shift):
        ...
        '''
        lower_keys = [j for j in string.ascii_lowercase]
        lower_values = [j for j in string.ascii_lowercase]
        shift_lower_values = lower_values[shift:] + lower_values[:shift]
        upper_keys = [j for j in string.ascii_uppercase]
        upper_values = [j for j in string.ascii_uppercase]
        ...
        self.shift_dict = {full_keys[j] : full_values[j] for j in range(len(full_keys))}
